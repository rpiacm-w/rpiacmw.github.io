...
// Define the function with the typewriter effect
function writeAnimation(element, message, delay, cursorDelay) {
  ...
  function togglePointer() {
    if (showPointer) {
      showPointer = 0;
      try {
        document.querySelector("#cursorElm").outerHTML = "";
      } catch (err) {
        return;
      }
    } else {
      showPointer = 1;
      element.innerHTML +=
        "<a id='cursorElm' style='color: white;position:absolute;'>|</a>";
    }
  }
  ...
  function writeText() {
    ...
    element.innerHTML =
      currentMessage +
      (showPointer ? "<a id='cursorElm' style='color: white;'>|</a>" : "");
    writeIndex++;
  }
}

// Call the function to apply the typewriter effect to the "meetOurTeam" element
var targetElement = document.getElementById("meetOurTeam");
var messageToWrite = "Meet our team.";
writeAnimation(targetElement, messageToWrite);
